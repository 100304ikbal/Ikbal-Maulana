...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 09:22 AM
...
(1, 'SK02', 'Ikbal Maulana', 'L', 'bandung', '088239278544'),
(3, 'SK01', 'Galuh', 'L', 'tegal', '08823988790'),
(4, 'SK02', 'ilmi', 'L', 'tegal', '08233367896');
...
--
ALTER TABLE `skema`
  MODIFY `Jml_unit` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
